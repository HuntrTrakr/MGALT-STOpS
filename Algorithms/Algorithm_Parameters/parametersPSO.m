...
switch selection
    ...
    case {'Rauwolf'}	% For the Rauwolf test case
    ...
    case {'Yam_IN_short'}  	% For the Yam test case
        
        options = struct(... 
        'Npop',50,...       	% Number of members in each population
        'tspan',60,...         % How many iterations to run for
        'vmax',0.7,...          % The max velocity of each particle
        'K',5,...               % The number of informants
        'cl',0.9,...            % The confidence in their own velocity
        'cmax',0.7);            % The confidence in other solutions
    
    case {'Yam_DIR_short'}  	% For the Yam test case
        
        options = struct(... 
        'Npop',40,...       	% Number of members in each population
        'tspan',50,...          % How many iterations to run for
        'vmax',0.7,...          % The max velocity of each particle
        'K',5,...               % The number of informants
        'cl',0.9,...            % The confidence in their own velocity
    ...
    case {'Yam_IN'}  	% For the Yam test case
        
        options = struct(... 
        'Npop',350,...       	% Number of members in each population
        'tspan',150,...         % How many iterations to run for
        'vmax',0.7,...          % The max velocity of each particle
        'K',5,...               % The number of informants
        'cl',0.9,...            % The confidence in their own velocity
        'cmax',0.7);            % The confidence in other solutions
    
    case {'Yam_DIR'}  	% For the Yam test case
        
        options = struct(... 
        'Npop',225,...       	% Number of members in each population
        'tspan',95,...          % How many iterations to run for
        'vmax',0.7,...          % The max velocity of each particle
        'K',5,...               % The number of informants
        'cl',0.9,...            % The confidence in their own velocity
        'cmax',0.7);            % The confidence in other solutions

    case {'Yam_IN_long'}  	% For the Yam test case
        
        options = struct(... 
        'Npop',500,...       	% Number of members in each population
        'tspan',225,...         % How many iterations to run for
        'vmax',0.7,...          % The max velocity of each particle
        'K',10,...               % The number of informants
        'cl',0.9,...            % The confidence in their own velocity
        'cmax',0.7);            % The confidence in other solutions
    
    case {'Yam_DIR_long'}  	% For the Yam test case

        options = struct(... 
        'Npop',325,...       	% Number of members in each population
        'tspan',130,...         % How many iterations to run for
        'vmax',0.7,...          % The max velocity of each particle
        'K',10,...               % The number of informants
        'cl',0.9,...            % The confidence in their own velocity
        'cmax',0.7);            % The confidence in other solutions
